...
interface PaymentRequest {
    /**
     * Adds an event listener to the PaymentRequest.  These callbacks can be used to update the payment request object
     ...
     * - afterpay_shippingoptionchanged: Occurs when a buyer chooses a shipping option in Afterpay/Clearpay.
     *
     * @example
