 ...
 * @private
 */
interface LegacyCardVerificationDetails {
    total: Money;
    intent: 'CHARGE' | 'CHARGE_AND_STORE';
    billingContact: BillingContact;
    customerInitiated: boolean;
...
type OsaVerificationDetails = CardVerificationDetails | LegacyCardVerificationDetails | StoreCardVerificationDetails;
export { ALLOWED_INPUT_PROPERTIES, ALLOWED_COMPONENT_PROPERTIES, ALLOWED_COMPONENT_STATE_PROPERTIES, ALLOWED_INPUT_TEXT_PROPERTIES, ALLOWED_INPUT_ICON_PROPERTIES, CardOptions, CardBrand, CardClassSelectors, CardDetails, CardInputEvent, CardInputEventState, CardVerificationDetails, ClassSelectors, CardType, ClientClassSelectors, ComponentPropertyValues, ComponentStatePropertyValues, InputPropertyValues, InputTextPropertyValues, LegacyCardVerificationDetails, OsaVerificationDetails, PrepaidType, StoreCardVerificationDetails, StylePropertyList, };
