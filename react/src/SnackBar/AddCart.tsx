...
type Props = { visible: boolean; onClose: () => void; onViewCart: () => void; item?: { name?: string } | null; };
  ...
  return (
    <div style={s.bar}>
      <div style={{ display: "flex", alignItems: "center", gap: 12, flex: 1 }}>
        <div style={s.iconWrap}><ShoppingCart size={18} style={{ color: "#3a7a22" }} /></div>
        <div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        <button onClick={onViewCart} style={s.viewCartBtn}>カートを見る</button>
