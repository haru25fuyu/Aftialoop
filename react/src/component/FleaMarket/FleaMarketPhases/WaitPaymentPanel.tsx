    ...
    <div style={s.wrap}>
        ...
        <div style={s.bannerInner}>
          ...
          <div>
            ...
            <p style={s.bannerDesc}>
              購入者が支払い手続きを進めています。支払いが完了するまで、商品の発送はお待ちください。
            </p>
          </div>
        </div>
      </div>
      ...
      <div style={s.section}>
        ...
        <div style={s.sectionBody}>
          <div style={s.row}>
            <span style={s.rowLabel}>商品価格</span>
            <span style={s.rowValue}>¥{itemPrice.toLocaleString()}</span>
          </div>
          <div style={s.row}>
            <span style={s.rowLabel}>
              送料（{isShippingIncluded ? "送料込み" : "着払い"}）
            </span>
          ...
          <div
            style={{
              height: 1,
              borderTop: "1px dashed #c4c1bb",
              margin: "8px 0",
            }}
          />
          <div style={s.totalRow}>
            <span style={s.rowLabel}>合計金額</span>
      ...
      <div style={{ ...s.section, borderColor: "#f0c4c4" }}>
        <div style={s.sectionBody}>
          <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
            <AlertTriangle
              size={20}
              style={{ color: "#d63c20", flexShrink: 0, marginTop: 2 }}
            />
            <div style={{ fontSize: 14, color: "#5c5a56" }}>
              <p style={{ fontWeight: 700, color: "#d63c20", marginBottom: 4 }}>
                ご注意ください
              </p>
              <p>
                支払いが完了する前に商品を発送してしまうと、トラブルの原因となります。必ず「支払い完了」の通知が来てから発送作業を行ってください。
              </p>
            </div>
          </div>
        </div>
