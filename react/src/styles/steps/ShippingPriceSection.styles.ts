...
export const s = {
  ...
  plusPctBtn: (active: boolean) => ({
    ...
    fontWeight: fontWeight.bold,
    cursor: "pointer",
    backgroundColor: active ? colors.neutral900 : "transparent",
    color: active ? colors.neutral0 : semantic.textSecondary,
  }),
};
