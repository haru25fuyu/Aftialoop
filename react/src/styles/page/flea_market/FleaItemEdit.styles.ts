...
export const s = {
page: { minHeight: "100vh", backgroundColor: semantic.bgSurfaceAlt, color: semantic.textPrimary, fontFamily: "inherit", paddingBottom: 128 },
...
headerInner: { maxWidth: 512, margin: "0 auto", paddingLeft: spacing[4], paddingRight: spacing[4], height: 56, display: "flex", alignItems: "center", justifyContent: "space-between" },
backBtn: { padding: spacing[1], background: "none", border: "none", cursor: "pointer", borderRadius: radius.full, color: semantic.textPrimary },
title: { fontWeight: fontWeight.bold, fontSize: fontSize.base },
progressTrack: { maxWidth: 512, margin: "0 auto", paddingLeft: spacing[4], paddingRight: spacing[4], height: 4, display: "flex" },
progressHalf: (active: boolean) => ({ flex: 1, height: "100%", transition: "all 0.3s", backgroundColor: active ? colors.info : colors.neutral200 }),
...
footer: { position: "fixed" as const, bottom: 0, left: 0, right: 0, backgroundColor: semantic.bgSurface, borderTop: `1px solid ${semantic.borderDefault}`, padding: `${spacing[3]}px ${spacing[4]}px` },
footerInner: { maxWidth: 572, margin: "0 auto", display: "flex", gap: spacing[3] },
cancelBtn: { flex: 1, height: 48, backgroundColor: colors.neutral100, color: semantic.textPrimary, border: "none", borderRadius: radius.lg, fontWeight: fontWeight.bold, cursor: "pointer" },
saveBtn: { flex: 2, height: 48, backgroundColor: colors.accent500, color: colors.neutral0, border: "none", borderRadius: radius.lg, fontWeight: fontWeight.bold, cursor: "pointer" },
};
