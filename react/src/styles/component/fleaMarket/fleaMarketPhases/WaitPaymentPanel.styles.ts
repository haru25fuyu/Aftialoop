...
banner: { borderRadius: radius.xl, border: `1px solid ${colors.primary200}`, backgroundColor: colors.warningBg, padding: spacing[5], color: colors.warning },
...
section: { borderRadius: radius.xl, border: `1px solid ${semantic.borderDefault}`, backgroundColor: semantic.bgSurface, overflow: "hidden" },
...
row: { display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: fontSize.sm },
