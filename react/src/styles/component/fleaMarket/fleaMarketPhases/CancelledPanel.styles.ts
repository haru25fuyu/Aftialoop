...
banner: { borderRadius: radius.xl, border: `1px solid ${colors.accent200}`, backgroundColor: colors.accent50, padding: spacing[5] },
bannerInner: { display: "flex", alignItems: "flex-start", gap: spacing[3] },
bannerTitle: { fontWeight: fontWeight.bold, fontSize: fontSize.lg, color: colors.accent500 },
bannerDesc: { fontSize: fontSize.sm, color: colors.accent500, marginTop: spacing[1], opacity: 0.9 },
