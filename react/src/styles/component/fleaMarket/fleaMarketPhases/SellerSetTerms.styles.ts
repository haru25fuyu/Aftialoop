...
export const s = {
  ...
  radioBtn: (checked: boolean, disabled?: boolean) => ({
    borderRadius: radius.xl,
    border: `1px solid ${checked ? colors.neutral900 : semantic.borderDefault}`,
    padding: spacing[3],
    textAlign: "left" as const,
    backgroundColor: checked ? colors.neutral100 : "transparent",
