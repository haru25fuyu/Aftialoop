...
export const s = {
btn: { display: "inline-flex", alignItems: "center", gap: spacing[2], padding: `${spacing[2]}px ${spacing[4]}px`, borderRadius: radius.lg, border: `1px solid ${colors.danger}`, backgroundColor: colors.dangerBg, color: colors.danger, fontSize: fontSize.sm, fontWeight: fontWeight.bold, cursor: "pointer" },
