        ...
        {loading ? (
          ...
          <>
            <div style={s.balanceCard}>
              <div style={{ color: "#a0d0b0", fontSize: 14, marginBottom: 4 }}>
                現在のポイント残高
              </div>
            ...
            <div style={s.list}>
              ...
              {!data.histories || data.histories.length === 0 ? (
                <div
                  style={{ padding: 32, textAlign: "center", color: "#8c8c8c" }}
                >
                  履歴はまだありません
                </div>
              ) : (
                  ...
                  {data.histories.map((item) => (
                    <div key={item.id} style={s.item}>
                      ...
                      >
                        <div
                          style={{
                            color: item.amount >= 0 ? "#3a7a22" : "#d63c20",
                            marginTop: 2,
                          }}
                        >
                          {item.amount >= 0 ? (
                        ...
                        <div>
                          <div style={{ fontWeight: 700, color: "#1a1a1a" }}>
                            {item.note || formatType(item.type)}
                          </div>
