  ...
  useEffect(() => {
    api
      ...
      .then((res) => {
        ...
        setCurrentPhone(u.phone_number || "");
        setIconUrl(u.icon_url || null);
        reset({
          name: u.name || "",
          username: u.username || "",
          bio: u.bio || "",
          ...
          <div style={s.section}>
            ...
            {[
              ...
              <div key={name} style={s.formGroup}>
                ...
                />
                {errors[name] && (
                  <p style={s.errMsg}>{errors[name]?.message}</p>
                )}
              </div>
            ))}
            ...
            {[
              ...
              >
                <div>
                  ...
                  <p
                    style={{ fontSize: 14, fontWeight: 500, color: "#2e3128" }}
                  >
                    {value || "未設定"}
                  </p>
                </div>
