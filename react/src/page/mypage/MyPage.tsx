...
const MenuItem = ({
  ...
  <Link to={to} style={s.menuItem}>
    ...
    <div style={{ flex: 1 }}>
      ...
      {sub && <div style={s.menuItemSub}>{sub}</div>}
    </div>
  ...
  return (
    <>
      ...
      <div style={s.page}>
        ...
        <div style={s.profileArea}>
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            ...
            >
              {user.icon_url ? (
                <img
                  src={CONFIG.BASE_URL + user.icon_url}
                  alt="avatar"
                ...
                >
                  <User size={32} style={{ color: "#8c8c8c" }} />
                </div>
              )}
            </div>
            <div style={{ flex: 1 }}>
            ...
            {[
              ...
              <div
                ...
                style={{
                  ...
                  textAlign: "center",
                  borderRight:
                    i < arr.length - 1 ? "1px solid #e0ddd8" : "none",
                }}
              >
                <div
        ...
        {/* 売上・ポイント */}
        <div style={s.grid2}>
          <Link to="/mypage/sales" style={s.statCard}>
            <div style={s.statCardIconRow}>
              <Wallet size={18} style={{ color: "#1a5adc" }} />
              売上金
            </div>
          ...
          <Link to="/mypage/points" style={s.statCard}>
            <div style={s.statCardIconRow}>
              <Coins size={18} style={{ color: "#3a7a22" }} />
              ポイント
            </div>
            <div style={{ fontSize: 20, fontWeight: 700, color: "#1a1a1a" }}>
          ...
          {[
            {
              ...
              label: "購入申請",
              count: user.pending_requests_count,
            },
            {
              to: "/mypage/transactions/active",
              icon: <Truck size={18} />,
              label: "取引中",
              count: user.active_transactions_count,
            },
          ].map(({ to, icon, label, count }) => (
            <Link key={to} to={to} style={s.grid2}>
              <div
                style={{
                  display: "flex",
                  alignItems: "center",
              ...
              <div style={{ fontSize: 22, fontWeight: 700 }}>
                {count}
                <span
                  style={{ fontSize: 12, fontWeight: 400, color: "#8c8c8c" }}
                >
                  件
                </span>
              </div>
        ...
        >
          {[
              ...
              items: [
                {
                  ...
                  label: "購入した商品・取引履歴",
                  to: "/mypage/transactions/history",
                  sub: "完了した取引はこちら",
                },
                {
                  icon: <Heart size={20} />,
            ...
            <section key={heading} style={s.menuSection}>
