...
export default function NotificationsPage() {
      ...
      try {
        ...
        setItems((prev) => {
          ...
          const filtered = newItems.filter(
            (i: Notification) => !exists.has(i.id),
          );
  ...
  const getIcon = (type: string) => {
    if (type === "OFFICIAL")
      return <Info size={20} style={{ color: "#1a5adc" }} />;
    if (type === "TRANSACTION")
      return <ShoppingBag size={20} style={{ color: "#3a7a22" }} />;
    if (type === "COMMENT")
      return <MessageCircle size={20} style={{ color: "#b85c00" }} />;
      ...
      <div style={{ maxWidth: 512, margin: "0 auto", padding: 16 }}>
        ...
        >
          {[
            ...
            <button
              key={val}
              onClick={() => setFilter(val as "ALL" | "OFFICIAL" | "PERSONAL")}
              style={{
                padding: "8px 16px",
                fontSize: 14,
                fontWeight: 700,
                ...
                color: filter === val ? "#3a7a22" : "#8c8c8c",
                borderBottom:
                  filter === val
                    ? "2px solid #3a7a22"
            ...
            displayItems.map((item, index) => (
              ...
              >
                ...
                <div style={s.body}>
                  ...
                  <div style={{ fontSize: 13, color: "#5c5a56", marginTop: 2 }}>
                    {item.body}
                  </div>
                  <div style={s.bodyDate}>
