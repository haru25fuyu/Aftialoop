...
export default function FleaItemCreatePage() {
  ...
  const summaryData: PublishSummary = {
    ...
    total:
      ...
      (formState.isMultiPurchasable ? formState.quantity : 1),
    ...
    shipsWithinDays:
      formState.shipsWithinDays === ""
        ? undefined
        : Number(formState.shipsWithinDays),
    ...
    <div className="min-h-screen bg-[#f8f9fa] pb-32">
      ...
      <div className="sticky top-14 z-30 bg-white border-b border-gray-200">
        <div className="max-w-lg mx-auto px-4 h-1 flex w-full">
          <div
            className={`h-full transition-all duration-300 ${systemState.currentStep === "main" ? "w-1/2 bg-blue-600" : "w-full bg-green-500"}`}
          />
